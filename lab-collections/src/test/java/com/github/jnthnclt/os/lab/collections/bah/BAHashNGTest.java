...
public class BAHashNGTest {
    ...
    public void testPut() throws Exception {
        ...
        BAHash<String> map = new BAHash<>(new BAHMapState<String>(10, true, BAHMapState.NIL), BAHasher.SINGLETON, BAHEqualer.SINGLETON);
    ...
    public void testLinkedPut() throws Exception {
        ...
        BAHash<String> map = new BAHash<>(new BAHLinkedMapState<String>(10, true, BAHLinkedMapState.NIL), BAHasher.SINGLETON, BAHEqualer.SINGLETON);
        internalTestPuts(map);
    }
